...
func (c *FakeApps) Apply(ctx context.Context, app *dekubev1.AppApplyConfiguration, opts metav1.ApplyOptions) (result *v1.App, err error) {
	if app == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(appsResource, c.ns, *name, types.ApplyPatchType, data), &v1.App{})
...
func (c *FakeApps) ApplyStatus(ctx context.Context, app *dekubev1.AppApplyConfiguration, opts metav1.ApplyOptions) (result *v1.App, err error) {
	if app == nil {
		return nil, fmt.Errorf("app provided to Apply must not be nil")
	}
	data, err := json.Marshal(app)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(appsResource, c.ns, *name, types.ApplyPatchType, data, "status"), &v1.App{})
