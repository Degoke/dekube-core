...
import (
	...
	v1 "github.com/Degoke/dekube-core/pkg/apis/dekube/v1"
	dekubev1 "github.com/Degoke/dekube-core/pkg/client/applyconfiguration/dekube/v1"
	scheme "github.com/Degoke/dekube-core/pkg/client/clientset/versioned/scheme"
...
type AppInterface interface {
	...
	Apply(ctx context.Context, app *dekubev1.AppApplyConfiguration, opts metav1.ApplyOptions) (result *v1.App, err error)
	ApplyStatus(ctx context.Context, app *dekubev1.AppApplyConfiguration, opts metav1.ApplyOptions) (result *v1.App, err error)
	AppExpansion
}
...
func newApps(c *DekubeV1Client, namespace string) *apps {
	return &apps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
// Apply takes the given apply declarative configuration, applies it and returns the applied app.
func (c *apps) Apply(ctx context.Context, app *dekubev1.AppApplyConfiguration, opts metav1.ApplyOptions) (result *v1.App, err error) {
	if app == nil {
		return nil, fmt.Errorf("app provided to Apply must not be nil")
	}
	...
	name := app.Name
	if name == nil {
		return nil, fmt.Errorf("app.Name must be provided to Apply")
	}
	result = &v1.App{}
...
func (c *apps) ApplyStatus(ctx context.Context, app *dekubev1.AppApplyConfiguration, opts metav1.ApplyOptions) (result *v1.App, err error) {
	if app == nil {
		return nil, fmt.Errorf("app provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
