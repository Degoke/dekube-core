...
import (
	...
	versioned "github.com/Degoke/dekube-core/pkg/client/clientset/versioned"
	internalinterfaces "github.com/Degoke/dekube-core/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/Degoke/dekube-core/pkg/client/listers/dekube/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.DekubeV1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DekubeV1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&dekubev1.App{},
		resyncPeriod,
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dekubev1.App{}, f.defaultInformer)
}
