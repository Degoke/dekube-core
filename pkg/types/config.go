...
type DekubeHandlers struct {

	// AppReader http.HandlerFunc
...
func (c *DekubeConfig) GetReadTimeout() time.Duration {
...
func (c *DekubeConfig) GetMaxIdleConns() int {
	if c.MaxIdleConns < 1 {
...
func (c *DekubeConfig) GetMaxIdleConnsPerHost() int {
